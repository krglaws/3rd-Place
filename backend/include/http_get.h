...
#define HTML_USER_ADMIN_TITLE "templates/user/admin_title.html"
#define HTML_USER_OWNER_TITLE "templates/user/owner_title.html"
#define HTML_USER_MOD_TITLE "templates/user/mod_title.html"
