...
#define USER_ADMIN_KEY (OPTIONAL_PREFIX "USER_ADMIN")
#define USER_OWNER_LIST_KEY (OPTIONAL_PREFIX "USER_OWNER_LIST")
#define USER_MOD_LIST_KEY (OPTIONAL_PREFIX "USER_MOD_LIST")

/* Community HTML keys */
#define COMMUNITY_POST_LIST_KEY "COMMUNITY_POST_LIST"
#define COMMUNITY_MOD_LIST_KEY "COMMUNITY_MOD_LIST"
