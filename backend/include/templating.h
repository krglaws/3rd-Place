...
#define EDIT_USER_LINK_DISPLAY_KEY "EDIT_USER_LINK_DISPLAY"
#define LOGOUT_USER_LINK_DISPLAY_KEY "LOGOUT_USER_LINK_DISPLAY"
#define DELETE_USER_LINK_DISPLAY_KEY "DELETE_USER_LINK_DISPLAY"
