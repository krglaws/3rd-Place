...
/* User form error keys: */
#define SIGNUP_ERR_KEY "SIGNUP_ERROR"
#define LOGIN_ERR_KEY "LOGIN_ERROR"
#define EDIT_PASSWD_ERR_KEY "EDIT_PASSWD_ERR"
#define EDIT_ABOUT_ERR_KEY "EDIT_ABOUT_ERR"

/* Post form error keys */
#define POST_FORM_ERR_KEY "POST_FORM_ERR"
#define EDIT_POST_FORM_ERR_KEY "EDIT_POST_FORM_ERR"

/* Comment form error keys */
#define COMMENT_FORM_ERR_KEY "COMMENT_FORM_ERR_KEY"
#define EDIT_COMMENT_FORM_ERR_KEY "EDIT_COMMENT_FORM_ERR_KEY"

/* Community form error keys */
#define COMMUNITY_FORM_ERR_KEY "COMMUNITY_FORM_ERR"
#define EDIT_COMMUNITY_FORM_ERR_KEY "EDIT_COMMUNITY_FORM_ERR"
