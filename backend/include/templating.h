...
#define EDIT_PASSWD_ERR_KEY (OPTIONAL_PREFIX "EDIT_PASSWD_ERR")
#define EDIT_ABOUT_ERR_KEY (OPTIONAL_PREFIX "EDIT_ABOUT_ERR")
...
/* Comment form keys */
#define COMMENT_FORM_ERR_KEY (OPTIONAL_PREFIX "COMMENT_FORM_ERR_KEY")
#define EDIT_COMMENT_FORM_ERR_KEY (OPTIONAL_PREFIX "EDIT_COMMENT_FORM_ERR_KEY")
...
#define FEED_TITLE_KEY (OPTIONAL_PREFIX "FEED_TITLE")
