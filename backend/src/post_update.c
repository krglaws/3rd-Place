...
struct response* update_user_about(const struct request* req)
{
  ...
  switch (valres)
  {
    ...
    case VALRES_TOO_SHORT:
      return get_edit_user(about_decoded, USER_FORM_ERR_ABOUT_TOO_SHORT, req->client_info);
    case VALRES_TOO_LONG:
      return get_edit_user(about_decoded, USER_FORM_ERR_ABOUT_TOO_LONG, req->client_info);
    case VALRES_INV_ENC:
      return get_edit_user(about_decoded, USER_FORM_ERR_ABOUT_INV_ENC, req->client_info);
    default:
...
struct response* update_user_password(const struct request* req)
{
  ...
  {
    return get_edit_user(NULL, USER_FORM_ERR_BAD_LOGIN, req->client_info);
  }

  // make sure new password inputs match
  if (newpass1 == NULL && newpass2 == NULL)
  {
    return get_edit_user(NULL, USER_FORM_ERR_PASSWD_TOO_SHORT, req->client_info);
  }

  if (newpass1 == NULL || newpass2 == NULL ||
      strcmp(newpass1, newpass2) != 0)
  {
    return get_edit_user(NULL, USER_FORM_ERR_PASSWD_MISMATCH, req->client_info);
  }
  ...
  switch (valres)
  {
    ...
    case VALRES_TOO_SHORT:
      return get_edit_user(NULL, USER_FORM_ERR_PASSWD_TOO_SHORT, req->client_info);
    case VALRES_TOO_LONG:
      return get_edit_user(NULL, USER_FORM_ERR_PASSWD_TOO_LONG, req->client_info);
    case VALRES_UNMET:
      return get_edit_user(NULL, USER_FORM_ERR_PASSWD_UNMET, req->client_info);
    case VALRES_INV_ENC:
      return get_edit_user(NULL, USER_FORM_ERR_PASSWD_INV_ENC, req->client_info);
    default:
...
struct response* update_post(const struct request* req)
{
  ...
  switch (valres)
  {
    case VALRES_OK:
      break;
    case VALRES_TOO_SHORT:
      return get_edit_post(body_decoded, post_id, POST_FORM_ERR_BODY_TOO_SHORT, req->client_info);
    case VALRES_TOO_LONG:
      return get_edit_post(body_decoded, post_id, POST_FORM_ERR_BODY_TOO_LONG, req->client_info);
    case VALRES_INV_ENC:
      return get_edit_post(body_decoded, post_id, POST_FORM_ERR_BODY_INV_ENC, req->client_info);
    default:
...
struct response* update_comment(const struct request* req)
{
  ...
  const char* comment_id = get_map_value_str(req->content, "comment_id");
  ...
  switch (valres)
  {
    case VALRES_OK:
      break;
    case VALRES_TOO_SHORT:
      return get_edit_comment(body_decoded, comment_id, COMMENT_FORM_ERR_TOO_SHORT, req->client_info);
    case VALRES_TOO_LONG:
      return get_edit_comment(body_decoded, comment_id, COMMENT_FORM_ERR_TOO_LONG, req->client_info);
    case VALRES_INV_ENC:
      return get_edit_comment(body_decoded, comment_id, COMMENT_FORM_ERR_INV_ENC, req->client_info);
    default:
...
struct response* update_community_about(const struct request* req)
{
  ...
  switch (valres)
  {
    case VALRES_OK:
      break;
    case VALRES_TOO_SHORT:
      return get_edit_community(about_decoded, community_id, COMMUNITY_FORM_ERR_ABOUT_TOO_SHORT, req->client_info);
    case VALRES_TOO_LONG:
      return get_edit_community(about_decoded, community_id, COMMUNITY_FORM_ERR_ABOUT_TOO_LONG, req->client_info);
    case VALRES_INV_ENC:
      return get_edit_community(about_decoded, community_id, COMMUNITY_FORM_ERR_ABOUT_INV_ENC, req->client_info);
    default:
